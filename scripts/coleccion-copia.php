            ...
            <table class="table table-hover grad w-auto mx-auto my-5">
                <thead>
                    <tr>
                        ...
                        ?>
                                <th class="pt-4">
                                    <button class="btn pl-0 font-weight-bold ordenar" data-array="<?php $datos ?>" id="ordenarNC">Nombre científico<i class="fas fa-sort-up"></i>
                                    </button>
                                </th>
                                <th>
                                    <button class="btn pl-0 font-weight-bold ordenar" id="ordenarNCas">Nombre castellano<i class="fas fa-sort-up"></i>
                                    </button>
                                </th>
                                <th>
                                    <button class="btn pl-0 font-weight-bold ordenar" id="ordenarNVal">Nombre valenciano<i class="fas fa-sort-up"></i>
                                    </button>
                                </th>
                                <th>
                                    <button class="btn pl-0 font-weight-bold ordenar" id="ordenarFamilia">Familia<i class="fas fa-sort-up"></i>
                                    </button>
                                </th>
                            <?php
                            }
